...
$(shell node -p '\
    ...
    getVal(`$(1)`.replace(" ", ""), require("./$(CONFIG_DIR)/project.json")); \
')
endef

VERSION = $(call ReadProjectConfig, version)
NAME = $(call ReadProjectConfig, name)
APP = $(NAME)_$(VERSION)
